...
THREE.StereoEffect = function ( renderer ) {
	...
	this.render = function ( scene, camera ) {
		...
		var sceneMeshL = scene.getObjectByName( "meshL", true );
		var sceneMeshR = scene.getObjectByName( "meshR", true );
		
		sceneMeshR.visible = false;
		sceneMeshL.visible = true;
		...
		sceneMeshR.visible = true;
		sceneMeshL.visible = false;
